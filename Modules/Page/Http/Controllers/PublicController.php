...
class PublicController extends BasePublicController
{
    ...
    public function uri($slug)
    {
        ...
        if(!in_array(\Request::segments()[0], ['mn','en'])){
          return redirect()->to($currentTranslatedPage->locale . '/' . $currentTranslatedPage->slug);
        }
    ...
    public function homepage()
    {
        ...
        if(!isset(\Request::segments()[0]) || !in_array(\Request::segments()[0], ['mn','en'])){
